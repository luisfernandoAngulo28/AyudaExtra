 ...
 * @author Usuario
 */
public class ListaRepDesor <T extends Comparable<T>> implements Cloneable {
    private Nodo<T> l;
    private int cant;

    public ListaRepDesor() {
        l=new Nodo<>();
        cant=0;
    }
...
// clona el objeto actual
    @Override
    protected ListaRepDesor<T> clone() throws CloneNotSupportedException {
        return (ListaRepDesor<T>) super.clone(); //To change body of generated methods, choose Tools | Templates.
    }
    /*
     ()
     1
    ...
    public String toString() {
        ...
        try {
            ...
            Logger.getLogger(ListaRepDesor.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public boolean DosListasIguales(ListaRepDesor L2)
    {
...
LlevarEleAlFinal(l.getEnlace(), l, pos);
    ...
    private void HacerUnicosDesordenados(Nodo<T> p)
    {
     if((p!=null)&&(p.getEnlace()!=null))
     {
     HacerUnicosDesordenados(p.getEnlace());
     Delete(p, p.getDato());
     }
    }
    
    public void HacerUnicosDesordenadosR()
    {
    HacerUnicosDesordenados(l.getEnlace());
    }
    
    
     private void ELiminarRepetidos(Nodo<T> p)
    {
     if((p!=null)&&(p.getEnlace()!=null))
     {
      ELiminarRepetidos(p.getEnlace());
      T aux =p.getDato();
      Delete(p.getEnlace(), aux);
      Delete(p, aux);
      
     }
    }
    
    public void EliminarRepetidoR()
    {   
     ELiminarRepetidos(l.getEnlace());
