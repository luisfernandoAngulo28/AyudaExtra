...
public class BitWise {
    ...
    public void SetDato(int pos, int dato) {
        if (dato <= Math.pow(2, this.Nbits) - 1) {
            if (pos <= Dim) {
                ...
                System.out.println("BitWise::SetDato::Error:Posicion Fuera de Rango");
            }
        } else {
            System.out.println("BitWise::SetDato:: Error:Fuera de Rango");
        }
    }
    ...
    public int GetDato(int pos) {
        if (pos <= this.Dim) {
            ...
            System.out.println("BitWise::GetDato:: Error:Posicion Fuera de Rango");
            return -1;
        }
    }
